		...
		<>
			...
			>
				<Flex className='socials' gap={"5"} alignItems={"center"} flexDirection={"row"}>
					...
					<Link isexternal='true' className='github' href='https://github.com/wsalas19'>
						<BsGithub />
					</Link>
					<Link isexternal='true' className='twitter' href='https://twitter.com/wsalas1905'>
						<BsTwitter />
					</Link>
				</Flex>
				...
				{size.width >= breakPoint ? (
					<Flex gap={3} alignItems={"center"} flexDirection={"row"}>
						...
						<SiNextdotjs color={"white"} /> <FaSass color='#dc3e74' /> <FaReact color='#5ed3f3' />{" "}
				...
				<Flex gap={3} alignItems={"center"} flexDirection={"row"}>
					...
					<Link href='https://war.ukraine.ua/donate/' isexternal='true'>
						<Image
							width={6}
							src={"https://cdn.britannica.com/14/4814-004-7C0DF1BB/Flag-Ukraine.jpg"}
							alt={"ukraine flag"}
						/>
					</Link>
				</Flex>
