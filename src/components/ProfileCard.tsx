			...
			<div className='flex bg-palette-alt  p-6 rounded-lg flex-col md:flex-row gap-3 w-[90%] md:w-[70%]'>
				...
				<div className=' gap-1 flex flex-col'>
					...
					<p className='text-md mt-1'>
						{
							"Experienced front-end developer with a background in architecture and graphic design. Collaborative team player adept at crafting custom full-stack applications for both local andinternational companies. Proficient in modern technologies like React and Node.js."
						}
					</p>
					<a
